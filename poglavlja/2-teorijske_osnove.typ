...
Радни оквир је развијен у програмском језику _Go_ @golang, који пружа подршку за конкурентно извршавање (енгл. _goroutines_) и богату стандардну библиотеку за _HTTP_, _TCP_ и _gRPC_ комуникацију. Конфигурација система дефинисана је у _YAML_ формату, чиме смо омогућили једноставан опис сервиса и свих параметара неопходних за провере и откривање проблема. 
...
У оквиру овог рада, _Prometheus_ прикупља метрике које систем излажe попут број извршених провера, број неуспешних провера и број поновних покретања контејнера, пружајући увид у здравље праћених сервиса током времена.
...
Због јасно дефинисане логике и широке примене у индустрији, _Kubernetes health-check_ механизам је у овом раду коришћен као референтни модел приликом дизајна независног радног оквира за проверу здравља сервиса.