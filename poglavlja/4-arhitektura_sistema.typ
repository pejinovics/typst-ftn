...
сервиса и припрема систем за извршавање периодичних циклуса провере активности. На слици #link(<fig:config_diagram>)[5] приказан је дијаграм секвенце који илуструје 
...
#figure(image("../slike/docker_diagram.svg", width: 80%),
  caption: [
...
#figure(image("../slike/diagram4.svg", width: 45%),
  caption: [
...
#figure(image("../slike/diagram2.svg", width: 60%),
  caption: [
